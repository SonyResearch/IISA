...
class ARNIQA(nn.Module):
    ...
    def __init__(self, regressor_dataset: str = 'koniq', pretrained: bool = True) -> None:
        super().__init__()
        ...
        object.__setattr__(self, 'encoder', encoder)    # Avoid saving encoder weights in the model state_dict
    ...
    def forward(self, x: torch.Tensor) -> float:
        ...
        score = self.regressor(f_combined).view(-1, 1)
